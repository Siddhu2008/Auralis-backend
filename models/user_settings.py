...
class UserSettings(db.Model):
    ...
    auto_send_emails = db.Column(db.Boolean, nullable=False, default=False)
    auto_schedule_meetings = db.Column(db.Boolean, nullable=False, default=False)
    auto_create_tasks = db.Column(db.Boolean, nullable=False, default=True)
    ...
    def to_dict(self):
        return {
            ...
            "auto_schedule_meetings": self.auto_schedule_meetings,
